...
set -eu
setopt PIPE_FAIL
# Background workers have separate process tests; keep offline checks deterministic.
...
"$OHECO_ROOT/bin/oo@0.1.0" remove oheco@0.4.0
...
"$oo_bin" switch oheco 0.1.0
"$OHECO_ROOT/bin/oo@0.4.0" switch oheco 0.4.0
